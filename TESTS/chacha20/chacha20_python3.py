...
def run_tests():
  ...
  hh = lambda x: binascii.hexlify(x)
  for i, (ciphertext, key, iv) in enumerate((
      ...
      (uh('cb0e01b0268516806ef210d5d318b1705aaf9185a5bbc1b9ecd7d8ef8e07e66f2479b51e297ac70add5e93a17de741bbd6d05ec274bb985c273b86ea'), uh('091831432ffabcbadefbde0fffffffffff41f0000234324432787080fffffeee'), uh('edffab1273621ff1')),
    ...
    print(hh(chacha20_encrypt(b'\0' * len(ciphertext), key, iv))) 
